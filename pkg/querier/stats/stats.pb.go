...
type Stats struct {
	...
	FetchedSamples    uint64 `protobuf:"varint,4,opt,name=fetched_samples,json=fetchedSamples,proto3" json:"fetched_samples,omitempty"`
}
...
func (m *Stats) GetFetchedSamples() uint64 {
	if m != nil {
		return m.FetchedSamples
	}
	return 0
}
...
var fileDescriptor_b4756a0aec8b9d44 = []byte{
	...
	,
}
...
func (this *Stats) Equal(that interface{}) bool {
	...
	if this.FetchedSamples != that1.FetchedSamples {
		return false
	}
	return true
}
func (this *Stats) GoString() string {
	...
	s = append(s, "FetchedSamples: "+fmt.Sprintf("%#v", this.FetchedSamples)+",\n")
	s = append(s, "}")
...
func (m *Stats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.FetchedSamples != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.FetchedSamples))
		i--
		dAtA[i] = 0x20
	}
...
func (m *Stats) Size() (n int) {
	...
	if m.FetchedSamples != 0 {
		n += 1 + sovStats(uint64(m.FetchedSamples))
	}
	return n
}
...
func (this *Stats) String() string {
	...
	s := strings.Join([]string{`&Stats{`,
		...
		`FetchedSamples:` + fmt.Sprintf("%v", this.FetchedSamples) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Stats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FetchedSamples", wireType)
			}
			m.FetchedSamples = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FetchedSamples |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
