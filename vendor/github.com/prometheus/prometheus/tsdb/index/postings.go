...
func NewShardedPosting(postings Postings, partitionCount uint64, partitionId uint64, labelsFn func(ref storage2.SeriesRef, lset *labels2.Labels, chks *[]chunks.Meta) error) *shardedPostings {
